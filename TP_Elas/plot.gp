...
set ylabel "erreur H1" 
set output "erreur_poutre.pdf" 

plot "poutre_convergence.txt" u 1:2 w lp ls 1 

set output "erreur_triangle.pdf" 

plot "convergence_U.txt" u 1:2 w lp ls 1 
